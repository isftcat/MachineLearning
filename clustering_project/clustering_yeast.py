...
result = singleLinkageClustering(raw_data,attribute_index,10)
print result
#print len(result[0])
#print len(result[1])
...
result = completeLinkageClustering(raw_data,attribute_index,10)
print result
#print len(result[0])
#print len(result[1])
hamming_distance = hammingDistanceCalculator(result,raw_data,target_index)
...
result = averageLinkageClustering(raw_data,attribute_index,10)
print result
#print len(result[0])
#print len(result[1])
hamming_distance = hammingDistanceCalculator(result,raw_data,target_index)
...
result = LloydMethodClustering(raw_data,attribute_index,10)
print result
#print len(result[0])
#print len(result[1])
hamming_distance = hammingDistanceCalculator(result,raw_data,target_index)
