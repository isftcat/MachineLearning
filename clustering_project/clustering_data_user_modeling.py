...
attribute_index = [0,1,2,3,4]
target_index = 5



print "Result of Single Linkage:"
result = singleLinkageClustering(raw_data,attribute_index,4)
print result
print len(result[0])
print len(result[1])
print len(result[2])
...
result = completeLinkageClustering(raw_data,attribute_index,4)
print result
print len(result[0])
print len(result[1])
print len(result[2])
...
result = averageLinkageClustering(raw_data,attribute_index,4)
print result
print len(result[0])
print len(result[1])
print len(result[2])
...
result = LloydMethodClustering(raw_data,attribute_index,4)
print result
print len(result[0])
print len(result[1])
print len(result[2])
